        ...
        <footer className="bg-gray-900 text-white">
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-8">
                    ...
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <div className="flex items-center gap-3 md:gap-4">
                            <Button
                                variant="ghost"
                                size="icon"
                                className="h-8 w-8 md:h-10 md:w-10 text-gray-300 hover:text-white hover:bg-gray-800"
                            >
                    ...
                    {/* Categories */}
                    <div>
                        <h3 className="font-semibold text-white mb-3 md:mb-4 text-sm md:text-base">Popular Topics</h3>
                        <ul className="space-y-2 md:space-y-3">
                            <li>
                                <Link href="#" className="text-gray-300 hover:text-white transition-colors text-sm">
                                    React & Next.js
                    ...
                    {/* Newsletter */}
                    <div className="sm:col-span-2 lg:col-span-1">
                        <h3 className="font-semibold text-white mb-3 md:mb-4 text-sm md:text-base">Stay Updated</h3>
                        ...
                        <div className="space-y-3">
                            <Input
                                ...
                                className="bg-gray-800 border-gray-700 text-white placeholder:text-gray-400 focus:border-blue-500 text-sm"
                            />
                            <Button
                                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium text-sm">
                                Subscribe
                            </Button>
                        </div>
