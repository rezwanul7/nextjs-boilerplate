        ...
        <FormField
            ...
            render={({field, fieldState}) => (
                <FormItem className={className}>
                    ...
                    <FormControl>
                        <div
                            className="border rounded-md focus-within:ring-3 focus-within:ring-ring focus-within:ring-opacity-50 focus-within:border-input flex w-full overflow-auto">
                            {/*<div className="">*/}
                            <BaseEditor
                                value={field.value}
